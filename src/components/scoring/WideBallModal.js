...
const WideBallModal = ({ visible, onClose, onSelectWide }) => {
  const wideOptions = [
    { label: "WD + 0", extraRuns: 0 },
    { label: "WD + 1", extraRuns: 1 },
    { label: "WD + 2", extraRuns: 2 },
    { label: "WD + 3", extraRuns: 3 },
    { label: "WD + 4", extraRuns: 4 },
    { label: "WD + 5", extraRuns: 5 },
    { label: "WD + 6", extraRuns: 6 },
          ...
          <View className="flex-row justify-between items-center mb-5 px-1">
            <View className="flex-row items-center">
              <Text className="text-slate-900 font-extrabold text-base">
                Wide ball <Text className="text-slate-500 font-semibold text-xs">(WD=1)</Text>
              </Text>
            </View>
